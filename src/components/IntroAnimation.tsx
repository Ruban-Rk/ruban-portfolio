  ...
  return (
    ...
    >
          ...
          <div className="font-extrabold text-[clamp(2.5rem,6vw,5rem)] leading-tight tracking-tight">
            ...
            <div
              ...
              style={{
                ...
                textShadow:
                  phase >= 2
                    ? `0 0 60px ${config.nameColor}cc, 0 0 20px ${config.nameColor}80`
                    : "none",
              }}
            >
              {config.nameText}
      ...
      >
        ...
        <img
          src={
            (config.useHeroImage ?? true)
              ? heroImageUrl || heroPortrait
              : config.imageUrl || heroPortrait
          }
          alt="Intro Portrait"
      ...
      <div
        ...
        style={{
          ...
          transform: phase >= CAR_PHASE ? "translateX(150vw)" : "translateX(-150%)",
        }}
      >
        <div className="relative w-full h-full flex items-center justify-center">
          ...
          {phase >= CAR_PHASE && (
            <div className="absolute -left-[500px] bottom-0 w-[800px] h-[350px] flex items-end opacity-80 z-30 pointer-events-none mix-blend-screen">
              ...
              <div
                className="w-[200px] h-[150px] bg-zinc-200 rounded-full blur-[40px] animate-pulse absolute bottom-10 left-[450px]"
                style={{ animationDuration: "0.3s" }}
              />

              {/* Expanding billows trailing behind */}
              <div
                className="w-[300px] h-[200px] bg-zinc-300 rounded-full blur-[50px] animate-pulse absolute bottom-0 left-[250px]"
                style={{ animationDuration: "0.5s", opacity: 0.9 }}
              />
              <div
                className="w-[450px] h-[250px] bg-zinc-400 rounded-full blur-[60px] animate-pulse absolute bottom-[-20px] left-[50px]"
                style={{ animationDuration: "0.7s", opacity: 0.8 }}
              />

              {/* Large dissipating trailing smoke */}
              <div
                className="w-[600px] h-[350px] bg-zinc-500 rounded-full blur-[80px] animate-pulse absolute bottom-[-50px] -left-[200px]"
                style={{ animationDuration: "1s", opacity: 0.6 }}
              />

              {/* Cinematic F1 tail-light reflection bouncing off the thickest smoke */}
              <div
                className="w-[150px] h-[100px] bg-red-600 rounded-full blur-[50px] animate-pulse absolute bottom-5 left-[450px] opacity-50"
